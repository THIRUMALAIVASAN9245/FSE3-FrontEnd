describe('Home With Admin User', () => {
  ...
  it('Visits the initial manage team member page and see the manage team member list', () => {
    cy.contains('Admin');
    cy.wait(1000);
  ...
  it('Verify login user in the table and see the manage team member list', () => {
    cy.contains('Admin');
    cy.wait(1000);
    cy.get('#nav-manage-team-member').click();
    cy.wait(1000);
